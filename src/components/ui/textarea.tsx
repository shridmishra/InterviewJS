...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex min-h-[100px] w-full rounded-xl border-2 border-[#e5e5e5] bg-white px-4 py-3 text-base font-medium text-[#3c3c3c] placeholder:text-[#afafaf] transition-all duration-200 outline-none",
