...
const typescriptProblems: Omit<Problem, 'status' | 'isStarred' | 'notes'>[] = [
  // Step 9: TypeScript Fundamentals - Basic Types (5 problems)
  {
...
problemsData.push(...typescriptProblems);

const progressiveProblems: Omit<Problem, 'status' | 'isStarred' | 'notes'>[] = [
    // Step 2: Array Manipulation (Medium)
    {
        id: 'zip-arrays',
    ...
    // Step 5: Object & Function Mastery (Hard)
    {
        ...
        testCases: [],
        solutionCheck: (_userCode: string): TestResult[] => [{ input: 'N/A', expected: 'Conceptual', actual: 'This assignment requires manual verification of object immutability.', passed: false, }],
    },];

problemsData.push(...progressiveProblems);