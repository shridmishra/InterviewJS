...
export const advancedDomAndEvents: Omit<Problem, 'status' | 'isStarred' | 'notes'>[] = [
    {
        ...
        difficulty: Difficulty.Easy, category: 'DOM', group: 'Step 6: Advanced DOM And Events',
    ...
    },
    {
        ...
        difficulty: Difficulty.Medium, category: 'DOM', group: 'Step 6: Advanced DOM And Events',
    ...
    },
    {
        ...
        difficulty: Difficulty.Hard, category: 'DOM', group: 'Step 6: Advanced DOM And Events',
