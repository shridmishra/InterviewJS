...
function PracticeJSDetailPage() {
    const router = useRouter();
    const params = useParams();
    const problemId = params.id as string;
    const { getProblemById, isLoading, isAuthLoading, handleStatusChange, handleToggleStar, handleUpdateNotes } = useChallenges('js');
...
export default PracticeJSDetailPage;
