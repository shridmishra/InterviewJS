...
const CircularProgress = ({ value }: { value: number }) => {
    ...
    const strokeColor = isComplete ? 'text-duo-gold' : 'text-duo-green';

    return (
        <div className="relative w-12 h-12 flex-shrink-0">
            <svg className="h-full w-full transform -rotate-90" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                <circle cx="18" cy="18" r="15" fill="none" className="stroke-current text-muted/40" strokeWidth="3"></circle>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                {isComplete ? (
                    <span className="text-duo-gold text-lg">✓</span>
                ) : (
                                    ...
                                    >
                                        ...
                                        <CardContent className="mt-auto py-0 px-4 ">
                                            ...
                                            <div className="space-y-4 pt-4 border-t border-border/50">
                                                ...
                                                <Button
                                                    size="default"
                                                    className="w-full btn-duo btn-duo-green font-bold h-11 text-base"
                                                    onClick={() => router.push(`/learn/${topic.slug}`)}
                                                >
                                                    <Code className="h-4 w-4 mr-2" />
                                                    Start Practice
